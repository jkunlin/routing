...
int main() {
  ...
  vector<Customer> customers = {
      Customer(0, 10.0, 50.0, 20.0, 0.0, 150.0, 20.0, 30.0),
      Customer(1, 15.0, 70.0, 30.0, 0.0, 200.0, 50.0, 60.0),
      Customer(2, 12.0, 60.0, 25.0, 0.0, 180.0, 80.0, 20.0),
      Customer(3, 18.0, 80.0, 35.0, 0.0, 220.0, 40.0, 90.0),
      Customer(4, 14.0, 65.0, 28.0, 0.0, 190.0, 60.0, 10.0),
      Customer(5, 16.0, 75.0, 32.0, 0.0, 210.0, 30.0, 70.0),
      // ... 可以添加更多客户
  };
